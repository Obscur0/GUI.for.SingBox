export default {
  ...
  kernel: {
    ...
    global: 'Global',
    direct: 'Direct',
    ruleDesp: 'Маршрутизация на основе правил',
    globalDesp: 'Траффик идет только через прокси-группу GLOBAL',
    directDesp: 'Прямое подключение всего трафика кроме правил',
  ...
  profiles: {
    ...
    start: 'Запуск/Перезапуск с этим профилем',
  ...
  settings: {
    ...
    autoStartKernel: 'Авто запуск ядра',
  ...
  tray: {
    ...
    exit: 'Выход',
    exitTip: 'Exit App',
    proxyGroup: 'Прокси-группы',
    setSystemProxy: 'Вкл системный прокси',
    clearSystemProxy: 'Выкл системный прокси',
    tun: 'TUN',
    enableTunMode: 'Вкл TUN',
    disableTunMode: 'Выкл TUN',
    kernel: 'Ядро',
